	...
	<div id="wrap" class="home-bg">
		...
		<section class="d-flex">
			...
			<div id="right-box">
				...
				<div class="side-box-border text-center mt-1 bg-primary"><a href="/post/photo_album_create_view?userId=${userId}" style="text-decoration-line: none; color: inherit;"><div class="mt-1">사진첩</div></a></div>
